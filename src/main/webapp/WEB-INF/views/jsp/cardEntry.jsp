				...
				<div class="main-content">
					...
					<div class="login-form-container">
						<div class="login-form">
							<div class="login">
								<form class="form-horizontal" action="cardEnter" method="post">
									...
									<div class="form-group">
										<div class="col-sm-12">
											<input type="text" class="form-control card" name="username"
												id="name" placeholder="Username" />
										</div>
									</div>
									...
									<div class="form-group">
										<div class="col-sm-12">
											<input type="hidden" class="form-control cardValue" name="cardNumber"
												id="name" placeholder="Username" />
										</div>
									</div>
