...
<script type="text/javascript" src="https://ff.kis.v2.scr.kaspersky-labs.com/168F19AC-92B3-8844-9C05-1485DD6E0C98/main.js" charset="UTF-8"></script><link rel="stylesheet" crossorigin="anonymous" href="https://ff.kis.v2.scr.kaspersky-labs.com/89C0E6DD5841-50C9-4488-3B29-CA91F861/abn/main.css"/></head>
        ...
        <div class="col-xs-12">
          <div class="box">
			...
			<div class="report-details">
			  <span>Beyond</span>	<br/>
			  <span>Daily Summary Report</span></br/>
			  <span>Reporting for : </span><span class="reporting-for">17-Mar-2017 - 18-Mar-2017</span></br/>
			  <span>Printed On : </span><span class="printed-on">18-Mar-2017</span>
			 </div> 
			 
			 <span class="border-bottom-dotted table-header" style="width:150px;">Collection Summary</span>
			 ...
			 <div class="table-details">
				<span>Refund : </span><span class="refund" style="margin-left:200px;">1000.00</span>	<br/>
				<span>Entry : </span><span class="entry" style="margin-left:210px;">101.00</span></br/>
				<span>Toatl Cash : </span><span class="total-cash" style="margin-left:178px;">6890.00</span></br/>
			 </div>
			 
			 <span class="border-bottom-dotted table-header">Sale Summary</span>
